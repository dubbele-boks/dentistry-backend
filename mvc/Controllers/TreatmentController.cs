...
namespace mvc.Controllers
{
    public class TreatmentController : Controller
    {
        ...
        {
            return View(await _context.Treatment.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Minutes,Price")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Minutes,Price")] Treatment treatment)
        {
            if (id != treatment.Id)
            {
                return NotFound();
